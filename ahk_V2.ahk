...
^!b:: ACTIVE_OR_OPEN_APP("brave.exe", "D:\scoop\apps\brave\current")
^!c:: ACTIVE_OR_OPEN_APP("chrome.exe", "C:\Program Files\Google\Chrome\Application")
^!d:: ACTIVE_OR_OPEN_APP("dbeaver.exe", "D:\scoop\apps\dbeaver\current")
^!f:: ACTIVE_OR_OPEN_APP("firefox.exe", "D:\scoop\apps\firefox\current")
^!j:: RUN_APP("idea64.exe", "D:\scoop\apps\idea\current\IDE\bin")
^!k:: ACTIVE_OR_OPEN_APP("KakaoTalk.exe", "D:\scoop\apps\kakaotalk\current")
^!m:: ACTIVE_OR_OPEN_APP("thunderbird.exe", "D:\scoop\apps\thunderbird\current\")
^!n:: ACTIVE_OR_OPEN_APP("Notion.exe", "D:\scoop\apps\notion\current")
^!o:: ACTIVE_OR_OPEN_APP("Obsidian.exe", "D:\scoop\apps\obsidian\current")
^!p:: RUN_APP("sumatrapdf.exe", "D:\scoop\apps\sumatrapdf\current")
^!r:: RUN_APP("raonMessenger.exe", "D:\Program Files\RaonsecureMessenger")
^!s:: ACTIVE_OR_OPEN_APP("slack.exe", "D:\scoop\apps\slack\current")
^!t:: ACTIVE_OR_OPEN_APP("wezterm-gui.exe", "D:\scoop\apps\wezterm-nightly\current")
